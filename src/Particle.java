...
public class Particle extends PApplet {
	...
	public static Logger log = Logger.getLogger(Particle.class);
	...
	public void setup() {
		...
		map.zoomToLevel(12);
		map.zoomAndPanTo(new Location(47.192104f,8.854508f), 12);
		...
		physics.setWorldBounds(new Rect(50, 50, width-50, height-50));
